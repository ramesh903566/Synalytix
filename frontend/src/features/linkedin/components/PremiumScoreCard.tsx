...
export const PremiumScoreCard: React.FC<PremiumScoreCardProps> = ({
  ...
  return (
    <div className="bg-bg-elevated border border-border-light rounded-2xl p-6 flex items-center justify-between relative overflow-hidden group">
      {/* Background Glow */}
      <div 
      ...
      <div className="max-w-[60%] z-10">
        ...
        {trend !== undefined && (
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs text-text-muted uppercase tracking-wider font-semibold">vs last 30d</span>
          </div>
        )}
      </div>
